    ...
    <div style={{fontFamily:fb,background:C.bg,color:C.white,minHeight:'100vh',WebkitFontSmoothing:'antialiased'}}>
      ...
      <section style={{background:C.bg,padding:'100px 32px 80px',textAlign:'center',position:'relative',overflow:'hidden'}}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{display:'flex',gap:'20px',justifyContent:'center',marginBottom:'32px',maxWidth:'800px',margin:'0 auto 32px'}}>
            <img src="/dollar_0.png" alt="Rent dollar" style={{width:'32%',height:'auto',borderRadius:'12px'}} />
            <img src="/dollar_1.png" alt="Groceries dollar" style={{width:'32%',height:'auto',borderRadius:'12px'}} />
            <img src="/dollar_2.png" alt="Savings dollar" style={{width:'32%',height:'auto',borderRadius:'12px'}} />
          </div>
