    ...
    <div style={{fontFamily:fb,background:C.bg,color:C.white,minHeight:'100vh',WebkitFontSmoothing:'antialiased'}}>
      ...
      <section style={{background:C.bg,padding:'100px 32px 80px',textAlign:'center',position:'relative',overflow:'hidden'}}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{fontFamily:fh,fontWeight:600,fontSize:'20px',color:C.cream,marginBottom:'20px',letterSpacing:'-0.01em'}}>Every dollar gets a job.</p>
          <p style={{fontSize:'17px',color:C.white,maxWidth:'600px',margin:'0 auto 16px',lineHeight:1.7,fontWeight:400}}>Most people look at their bank balance and hope there's enough left when the bills come. We do it different.</p>
          <p style={{fontSize:'17px',color:C.white,maxWidth:'600px',margin:'0 auto 16px',lineHeight:1.7,fontWeight:400}}>We give every dollar a job before it even hits your account. Your rent dollar knows it's rent. Your cell phone dollar knows it's your phone bill. Your grocery dollar knows it's groceries. Your emergency fund dollar sits there until you need it.</p>
          <p style={{fontSize:'17px',color:C.white,maxWidth:'600px',margin:'0 auto 44px',lineHeight:1.7,fontWeight:400}}>No more guessing. No more scrambling at the end of the month. Every dollar has a purpose, and every purpose gets paid.</p>
